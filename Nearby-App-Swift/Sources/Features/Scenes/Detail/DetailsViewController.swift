...
class DetailsViewController: UIViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            regulationTitleLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
            ...
            couponTitleLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 16),
        ...
        applyLateralConstrants(to: descriptionLabel)
        applyLateralConstrants(to: infoStackView)
        applyLateralConstrants(to: divider)
        applyLateralConstrants(to: divider2)
        applyLateralConstrants(to: regulationLabel)
        applyLateralConstrants(to: couponStackView)
        applyLateralConstrants(to: qrCodeButton)
        
    }
    
    private func applyLateralConstrants(to view: UIView) {
        NSLayoutConstraint.activate([
    ...
    private func configureDetails() {
        ...
        º Válido apenas para consumo no local
        
        º Disponível até 31/12/2024
        """
